...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="clientes.php">Tabla Cliente</a>
            <a class="dropdown-item" href="pedidos.php">Tabla Pedidos</a>
            <a class="dropdown-item" href="eventos.php">Tabla Eventos</a>
            <a class="dropdown-item" href="inventario.php">Tabla Inventario</a>
